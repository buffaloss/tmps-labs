...
fun facadeDemonstration() {
    ...
    val songs = listOf(
        Song("Bohemian Rhapsody", "01-11-1975", 5.55f, "Queen",
            SongImplementation("Bohemian Rhapsody", "01-11-1975", 5.55f, "Queen")
        ),
        Song("Imagine", "09-09-1971", 3.01f, "John Lennon",
            SongImplementation("Imagine", "09-09-1971", 3.01f, "John Lennon"))
    )
    ...
    val mediaItems = listOf(
        Song("Smells Like Teen Spirit", "10-09-1991", 5.01f, "Nirvana",
            SongImplementation("Smells Like Teen Spirit", "10-09-1991", 5.01f, "Nirvana")),
        Podcast("The Daily: Today's Headlines", "12-03-2023", 20.0f, "The New York Times",
            PodcastImplementation("The Daily: Today's Headlines", "12-03-2023", 20.0f, "The New York Times")
        )
    )
